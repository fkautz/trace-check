...
func main() {
	...
	strict := fs.Bool("strict", false, "enforce full coverage: every requirement needs a tagged test or waiver, and every classification value that requires a coverage class must have one")
